...
`--router_temperature 1.0`. To run the baseline-preserving residual variant,
add `--use_router_residual`.
...
The evidence gates are initialized with small probabilities, keeping the
