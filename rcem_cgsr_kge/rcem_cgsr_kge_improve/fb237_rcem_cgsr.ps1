...
python learn.py --dataset FB237 `
        ...
        --use_rcem `
        --rcem_max_rules 8 --rcem_max_candidates 32 `
        --rcem_min_rule_support 4 --rcem_max_rule_degree 48 `
        --rcem_path_strength 0.10 --rcem_type_strength 0.05 `
        --rcem_path_gate_init 0.05 --rcem_type_gate_init 0.05 `
        --rcem_warmup_epochs 3 --rcem_ramp_epochs 15 `
